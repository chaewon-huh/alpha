...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // src/ui/sftime/sftime.js
  var SFTime = class extends s4 {
    constructor() {
      super();
      this.updateTime();
    }
    ...
    getSFTime() {
      const sfTime = (/* @__PURE__ */ new Date()).toLocaleTimeString("en-US", {
    ...
    updateTime() {
      this.requestUpdate();
      setTimeout(() => this.updateTime(), 6e4);
    }
    connectedCallback() {
...
lit-html/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=sftime-bundle.js.map
